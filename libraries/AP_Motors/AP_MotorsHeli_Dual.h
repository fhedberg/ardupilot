...
public:
    ...
    int16_t get_estimated_rotor_speed() const { return _rotor.get_estimated_speed(); }

    // get_desired_rotor_speed - gets target rotor speed as a number from 0 ~ 1000
    int16_t get_desired_rotor_speed() const { return _rotor.get_desired_speed(); }

    // rotor_speed_above_critical - return true if rotor speed is above that critical for flight
    bool rotor_speed_above_critical() const { return _rotor.get_estimated_speed() > _rotor.get_critical_speed(); }
