...
{
    return _rotor.get_desired_speed() == 0;
}
...
int16_t AP_MotorsHeli_Dual::get_desired_rotor_speed() const
{
    return _rotor.get_desired_speed();
}

// get_estimated_rotor_speed
int16_t AP_MotorsHeli_Dual::get_estimated_rotor_speed()
{
    return _rotor.get_estimated_speed();
}
