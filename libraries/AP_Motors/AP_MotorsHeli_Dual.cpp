...
void AP_MotorsHeli_Dual::move_actuators(float roll_out, float pitch_out, float collective_in, float yaw_out)
{
    ...
    rc_write(AP_MOTORS_MOT_1, _swash_servo_1_out);
    rc_write(AP_MOTORS_MOT_2, _swash_servo_2_out);
    rc_write(AP_MOTORS_MOT_3, _swash_servo_3_out);
    rc_write(AP_MOTORS_MOT_4, _swash_servo_4_out);
    rc_write(AP_MOTORS_MOT_5, _swash_servo_5_out);
    rc_write(AP_MOTORS_MOT_6, _swash_servo_6_out);
