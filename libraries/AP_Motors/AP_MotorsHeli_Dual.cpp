...
{    // range check collective min, max and mid
    ...
    _rotor.set_control_mode(_rsc_mode);
...
void AP_MotorsHeli_Dual::update_motor_control(uint8_t state)
{
...
{    
    ...
    hal.rcout->write(pgm_read_byte(&_motor_to_channel_map[AP_MOTORS_MOT_4]), _swash_servo_4.radio_out);
    hal.rcout->write(pgm_read_byte(&_motor_to_channel_map[AP_MOTORS_MOT_5]), _swash_servo_5.radio_out);
    hal.rcout->write(pgm_read_byte(&_motor_to_channel_map[AP_MOTORS_MOT_6]), _swash_servo_6.radio_out);
}