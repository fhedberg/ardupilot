...
void AP_MotorsHeli_Tiltrotor::calculate_roll_pitch_collective_factors()
{
    if (_tilt_mode == AP_MOTORS_HELI_TILTROTOR_MODE_TVEC) {
        // roll factors
        _rollFactor[CH_1] = _dcp_scaler * sinf(radians(_tvec_angle)) + cosf(radians(_servo1_pos - _swash1_phase_angle)) * cosf(radians(_tvec_angle));
        _rollFactor[CH_2] = _dcp_scaler * sinf(radians(_tvec_angle)) + cosf(radians(_servo2_pos - _swash1_phase_angle)) * cosf(radians(_tvec_angle));
        _rollFactor[CH_3] = _dcp_scaler * sinf(radians(_tvec_angle)) + cosf(radians(_servo3_pos - _swash1_phase_angle)) * cosf(radians(_tvec_angle));

        _rollFactor[CH_4] = -_dcp_scaler * sinf(radians(_tvec_angle)) + cosf(radians(_servo4_pos + 180 - _swash2_phase_angle)) * cosf(radians(_tvec_angle));
        _rollFactor[CH_5] = -_dcp_scaler * sinf(radians(_tvec_angle)) + cosf(radians(_servo5_pos + 180 - _swash2_phase_angle)) * cosf(radians(_tvec_angle));
        _rollFactor[CH_6] = -_dcp_scaler * sinf(radians(_tvec_angle)) + cosf(radians(_servo6_pos + 180 - _swash2_phase_angle)) * cosf(radians(_tvec_angle));
        ...
        // yaw factors
        _yawFactor[CH_1] = cosf(radians(_servo1_pos + 180 - _swash1_phase_angle)) * sinf(radians(_tvec_angle)) + _dcp_scaler * cosf(radians(_tvec_angle));
        _yawFactor[CH_2] = cosf(radians(_servo2_pos + 180 - _swash1_phase_angle)) * sinf(radians(_tvec_angle)) + _dcp_scaler * cosf(radians(_tvec_angle));
        _yawFactor[CH_3] = cosf(radians(_servo3_pos + 180 - _swash1_phase_angle)) * sinf(radians(_tvec_angle)) + _dcp_scaler * cosf(radians(_tvec_angle));

        _yawFactor[CH_4] = cosf(radians(_servo4_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle)) - _dcp_scaler * cosf(radians(_tvec_angle));
        _yawFactor[CH_5] = cosf(radians(_servo5_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle)) - _dcp_scaler * cosf(radians(_tvec_angle));
        _yawFactor[CH_6] = cosf(radians(_servo6_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle)) - _dcp_scaler * cosf(radians(_tvec_angle));
        ...
        // pitch factors
        _pitchFactor[CH_1] = cosf(radians(_servo1_pos - _swash1_phase_angle)) * sinf(radians(_tvec_angle));
        _pitchFactor[CH_2] = cosf(radians(_servo2_pos - _swash1_phase_angle)) * sinf(radians(_tvec_angle));
        _pitchFactor[CH_3] = cosf(radians(_servo3_pos - _swash1_phase_angle)) * sinf(radians(_tvec_angle));

        _pitchFactor[CH_4] = cosf(radians(_servo4_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle));
        _pitchFactor[CH_5] = cosf(radians(_servo5_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle));
        _pitchFactor[CH_6] = cosf(radians(_servo6_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle));

        // yaw factors
        _yawFactor[CH_1] = cosf(radians(_servo1_pos + 180 - _swash1_phase_angle)) * sinf(radians(_tvec_angle));
        _yawFactor[CH_2] = cosf(radians(_servo2_pos + 180 - _swash1_phase_angle)) * sinf(radians(_tvec_angle));
        _yawFactor[CH_3] = cosf(radians(_servo3_pos + 180 - _swash1_phase_angle)) * sinf(radians(_tvec_angle));

        _yawFactor[CH_4] = cosf(radians(_servo4_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle));
        _yawFactor[CH_5] = cosf(radians(_servo5_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle));
        _yawFactor[CH_6] = cosf(radians(_servo6_pos - _swash2_phase_angle)) * sinf(radians(_tvec_angle));
    }
